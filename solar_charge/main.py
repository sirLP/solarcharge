...
def _parse_battery_guard(raw: dict) -> BatteryGuardConfig | None:
    ...
    cfg = BatteryGuardConfig(
        ...
        use_tomorrow_forecast=bool(raw.get("use_tomorrow_forecast", True)),
        tomorrow_overcast_threshold=float(raw.get("tomorrow_overcast_threshold", 70.0)),
        tomorrow_night_reserve_max_pct=float(raw.get("tomorrow_night_reserve_max_pct", 95.0)),
